                      ...
                      return ListTile(
                        ...
                        onTap: (){
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (BuildContext context) => DetailPage(user:user, restaurant: fastFood[index])))
                ...
                ListView.builder(
                    ...
                    itemBuilder: (context, index){
                      return ListTile(
                        ...
                        onTap: (){
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (BuildContext context) => DetailPage(user:user, restaurant: chinese[index])))
                              .catchError((e) => print(e));
                        }
                      );
                    }
                ...
                ListView.builder(
                    ...
                    itemBuilder: (context, index){
                      return ListTile(
                        ...
                        onTap: (){
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (BuildContext context) => DetailPage(user:user, restaurant: japanese[index])))
                              .catchError((e) => print(e));
                        }
                      );
                    }
                ...
                ListView.builder(
                    ...
                    itemBuilder: (context, index){
                      return ListTile(
                        ...
                        onTap: (){
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (BuildContext context) => DetailPage(user:user, restaurant: boonSick[index])))
                              .catchError((e) => print(e));
                        }
                      );
                    }
